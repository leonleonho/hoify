...
export type RequestMusicDownloadMutationVariables = Exact<{
  artistName: string;
...
export type RequestMusicDownloadMutation = { requestMusicDownload: { id: string, status: string } };
...
export const RequestMusicDownloadDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RequestMusicDownload"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"artistName"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"albumName"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"songName"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"requestMusicDownload"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"artistName"},"value":{"kind":"Variable","name":{"kind":"Name","value":"artistName"}}},{"kind":"Argument","name":{"kind":"Name","value":"albumName"},"value":{"kind":"Variable","name":{"kind":"Name","value":"albumName"}}},{"kind":"Argument","name":{"kind":"Name","value":"songName"},"value":{"kind":"Variable","name":{"kind":"Name","value":"songName"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"status"}}]}}]}}]} as unknown as DocumentNode<RequestMusicDownloadMutation, RequestMusicDownloadMutationVariables>;
